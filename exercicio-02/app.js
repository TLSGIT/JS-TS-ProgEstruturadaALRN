...
*/
// OK - Feito no arquivo index.html
/*
...
const sizeConst = `O tamanho da constante "${programmingLanguage}" é de: ${programmingLanguage.length} caracteres.`
...
let realBestMovie = bestMovie.slice(0, -13) + " Moonlight."
