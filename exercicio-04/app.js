...
const my3FavoriteTVShows = ['The Walking Dead', 'LOST', 'Prison Break']
...
let arrayBoolSize = my3FavoriteTVShows.length === 3 ? true : false

console.log(`A const criada possui 3 itens? ${arrayBoolSize}`)
...
console.log(isNotAString !== 'string' ? true : false)
