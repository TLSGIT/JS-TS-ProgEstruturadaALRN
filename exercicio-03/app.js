...
*/
const foodsInfo = 'Até aqui, o array \"brazilianFoods\" possui NUMERO_DE_ITENS itens: NOME_DO_ITEM_1, NOME_DO_ITEM_2, NOME_DO_ITEM_3.'
...
//let dogNames = [...maleDogNames, ...femaleDogNames]; // Usando desmembramento de itens de array com '...'
let dogNames = maleDogNames.concat(femaleDogNames) // Usando método tradicional de concat.
//let dogNames = new Array()
//dogNames.push(maleDogNames)
//dogNames.push(femaleDogNames)
...
console.log(dessert) // Aqui resulta em "cocana"
console.log(dessert.replace('n', 'd')) // Aqui resulta em "cocada"
